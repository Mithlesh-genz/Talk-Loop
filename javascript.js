...
//if change user then change hole data of the chatBtmP data
function userData(data, receiver) {
    if (!rightCantainer || !data) return;
    appendMessage(receiver || currentUser || "default data", data, "right");
}
